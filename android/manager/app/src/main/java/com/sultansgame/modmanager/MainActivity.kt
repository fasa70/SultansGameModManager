            ...
            MiuixTheme(controller = remember { ThemeController(ColorSchemeMode.System) }) {
                ...
                ManagerApp(
                    ...
                    actions = ManagerActions(
                        ...
                        openSaveEditor = viewModel::openSaveEditor,
                        closeSaveEditor = viewModel::closeSaveEditor,
                        loadSaveUsers = viewModel::loadSaveUsers,
                        selectSaveUser = viewModel::selectSaveUser,
                        selectSaveFile = viewModel::selectSaveFile,
                        leaveSaveFile = viewModel::leaveSaveFile,
