...
internal const val GITHUB_REPO_URL = "https://github.com/fasa70/SultansGameModManager"

internal fun isAllowedGitHubRepoUrl(url: String): Boolean {
    ...
    return parsed.scheme == "https" &&
        ...
        parsed.path == "/fasa70/SultansGameModManager"
}
